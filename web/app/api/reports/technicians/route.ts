...
import { getTechnicianPerformance } from '@/modules/reports/reports.service';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await getTechnicianPerformance(filters);
    ...
    console.error('Technician reports API error:', error);
    return NextResponse.json(
