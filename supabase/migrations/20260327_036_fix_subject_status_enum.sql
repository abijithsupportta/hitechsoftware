-- =====================================================================
-- Hi Tech Software - Fix Subject Status Enum (URGENT) - Simplified
-- Migration: 20260327_036_fix_subject_status_enum.sql
...
-- Change column type with explicit mapping
ALTER TABLE public.subjects 
...
DO $$
BEGIN
  RAISE NOTICE '=== MIGRATION 036 COMPLETED ===';
  RAISE NOTICE '✅ Fixed subject_status enum from uppercase to lowercase';
  RAISE NOTICE '✅ Dropped and recreated dependent views and materialized views';
